...
author: "Dr Omar, Dr Zaim, Dr Hafiz, Dr Syuaib"
format: 
  html:
    toc: true
    toc-title: Contents
...
2.  For each year increase in duration of employment (or other unit of time), their literacy
    score slightly decreases by 0.08 points. This might suggest that the longer
    someone remains in their current employment, perhaps the less they engage in
    activities that boost their literacy, or it might reflect other life pressures.
3.  House officer working in HSIP has significantly increase a person's literacy score
    by 2.1 points, indicating that this Hospital has a positive impact on mental health literacy compared to Hospital Tanah Merah which decrease 0.06 literacy score and Hospital Universiti Sains Malaysia which decrease 0.09 literacy score.
